...
| **Payment dues (PPT-070)**      | Children **#164–#167 closed**; epic [#163](https://github.com/Elmorralito/save-ma-money/issues/163) open pending PPT-075 / [#168](https://github.com/Elmorralito/save-ma-money/issues/168) docs/tests close-out. Index: [`docs/issues/README.md` Part VIII](../issues/README.md#part-viii--ppt-070-payment-due-date-reminders-163) |

Part V in [`ARCHITECTURE.md`](ARCHITECTURE.md#part-v--api-coverage-matrix-ppt-033-43) records the #43-era matrix plus a post-delivery note; Part VIII records PPT-044; Part IX records PPT-045 packaging; PPT-070 dues index is [`docs/issues/README.md` Part VIII](../issues/README.md#part-viii--ppt-070-payment-due-date-reminders-163); `.strata/memory/project_state.md` tracks the active sprint.
...
| [`../issues/README.md` Part VIII](../issues/README.md#part-viii--ppt-070-payment-due-date-reminders-163)                       | [#163](https://github.com/Elmorralito/save-ma-money/issues/163)                                                                       | **In progress** (PPT-075 / #168)       | In-app payment dues on `transaction_templates` (schema → API → SPA)                     |
