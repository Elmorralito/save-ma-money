...
| **Payment dues (PPT-070)**      | Closed ([#163](https://github.com/Elmorralito/save-ma-money/issues/163)) — children #164–#168 delivered (PRs #197–#207). Index: [`docs/issues/README.md` Part VIII](../issues/README.md#part-viii--ppt-070-payment-due-date-reminders-163) |
...
| [`../issues/README.md` Part VIII](../issues/README.md#part-viii--ppt-070-payment-due-date-reminders-163)                       | [#163](https://github.com/Elmorralito/save-ma-money/issues/163)                                                                       | **Closed**                             | In-app payment dues on `transaction_templates` (schema → API → SPA)                     |
