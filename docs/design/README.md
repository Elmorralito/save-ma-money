...
| [`PPT-031-v0-audit.md`](PPT-031-v0-audit.md)                                                       | [#30](https://github.com/Elmorralito/save-ma-money/issues/30)         | Draft   | As-is schema audit (3NF, handlers, API gaps) |
...
| `PPT-031-migration-runbook.md` _(planned)_                                                         | [#34](https://github.com/Elmorralito/save-ma-money/issues/34)         | Pending | Alembic + Supabase PostgreSQL validation     |
...
| **D** | Migration + validation | [#34](https://github.com/Elmorralito/save-ma-money/issues/34)         | `PPT-031-migration-runbook.md`                                                           | Not started                                                                                                                       |
...
Gates that must clear before downstream work proceeds. Status reflects repo state as of 2026-07-05.

| Gate                                      | Blocks                                                                                                                                               | Status      | Owner action                                                                                                                                                                |
| ----------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **G0 — v0 audit sign-off**                | Closing [#30](https://github.com/Elmorralito/save-ma-money/issues/30); starting v1 ([#32](https://github.com/Elmorralito/save-ma-money/issues/32))   | **Pending** | Review [`PPT-031-v0-audit.md`](PPT-031-v0-audit.md) §12–§14 (NF register); comment approval on #30; bump v0 status Draft → Complete                                         |
...
| **G6 — Legacy data migration (FR-14)**    | `./deploy/alembic.sh upgrade` on pre-#26 dumps                                                                                                       | **Pending** | Document in `PPT-031-migration-runbook.md` ([#34](https://github.com/Elmorralito/save-ma-money/issues/34))                                                                  |
