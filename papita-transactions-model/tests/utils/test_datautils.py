...
class TestModelWithAlias(BaseModel):
...
def test_standardize_dataframe_basic(sample_df):
    ...
    result = standardize_dataframe(TestModel, sample_df[list(set(TestModel.model_fields) - {"to_drop"})])
...
def test_standardize_dataframe_with_drops(sample_df):
    ...
    result = standardize_dataframe(TestModel, sample_df, drops=["to_drop"])
...
def test_standardize_dataframe_with_kwargs(sample_df):
    ...
    CustomTestModel = deepcopy(TestModel)
    CustomTestModel.model_config = ConfigDict(extra="allow")
    result = standardize_dataframe(CustomTestModel, sample_df, new_column="value")
...
def test_standardize_dataframe_by_alias(sample_df):
    ...
    result = standardize_dataframe(TestModelWithAlias, df, by_alias=True, drops=["to_drop"])
...
def test_standardize_dataframe_type_error_handling():
    ...
    result = standardize_dataframe(TestModel, df)
