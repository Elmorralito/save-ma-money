...
Revision ID: 4ef31860ba8d
<<<<<<< HEAD
Revises:
=======
Revises: 
>>>>>>> 957ca23 (Checkpoint.)
Create Date: 2025-10-01 21:43:11.069970+00:00
...
=======
    op.execute(
        sa.schema.CreateSchema("papita_transactions", if_not_exists=True)
    )
>>>>>>> 957ca23 (Checkpoint.)
...
=======
        sa.Column(
            "entity", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
        sa.Column(
            "account_number", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
>>>>>>> 957ca23 (Checkpoint.)
        sa.PrimaryKeyConstraint("id"),
        schema="papita_transactions",
...
=======
            sa.Enum(
                "FULL", "PARTIAL", name="realestateassetaccountsownership"
            ),
>>>>>>> 957ca23 (Checkpoint.)
            nullable=False,
        ),
...
=======
        sa.Column(
            "bank_credit_liability_account_id", sa.Uuid(), nullable=False
        ),
>>>>>>> 957ca23 (Checkpoint.)
...
=======
        ...
        sa.Column(
            "discriminator", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
>>>>>>> 957ca23 (Checkpoint.)
        sa.ForeignKeyConstraint(
            ["classification"],
...
=======
        sa.Column(
            "bank_credit_liability_account_id", sa.Uuid(), nullable=True
        ),
        sa.Column(
            "credit_card_liability_account_id", sa.Uuid(), nullable=True
        ),
>>>>>>> 957ca23 (Checkpoint.)
        sa.ForeignKeyConstraint(
            ["account_id"],
    ...
    op.create_table(
        ...
        sa.Column(
            "planned_transaction_day", sa.SmallInteger(), nullable=False
        ),
        sa.ForeignKeyConstraint(
            ["type_id"],
            ["papita_transactions.types.id"],
...
=======
    op.drop_table(
        "credit_card_liability_accounts", schema="papita_transactions"
    )
>>>>>>> 957ca23 (Checkpoint.)
    op.drop_index(
        op.f("ix_papita_transactions_banking_asset_accounts_entity"),
...
=======
    op.drop_table(
        "bank_credit_liability_accounts", schema="papita_transactions"
    )
>>>>>>> 957ca23 (Checkpoint.)
