...
- **`modules/web`** — `@papita/web`: Vite + React 19 + TypeScript SPA (epic PPT-046 / [#112](https://github.com/Elmorralito/save-ma-money/issues/112)). Scaffold PPT-047 / [#113](https://github.com/Elmorralito/save-ma-money/issues/113); OpenAPI client PPT-048; BFF cookies PPT-049; design system + `AppLayout` PPT-051 / [#116](https://github.com/Elmorralito/save-ma-money/issues/116) (Tailwind v4 + shadcn/ui tokens/primitives, lazy stub routes). pnpm workspace; presentation only — no domain logic. Dev proxy `/api` → `:8000`; quality via `web-ci.yml`. OpenAPI typegen **strategy B** (PPT-065 / [#130](https://github.com/Elmorralito/save-ma-money/issues/130)). Feature CRUD / forms / nginx are later epic children.
