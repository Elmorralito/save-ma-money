...
| Auth direction  | **Supabase Auth** (PPT-039 / [#49](https://github.com/Elmorralito/save-ma-money/issues/49)); local HS256 being replaced — see `docs/issues/PPT-039-supabase-auth-reissue.md` |
