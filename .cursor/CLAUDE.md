...
| API status   | Runnable app: health, auth, accounts, categories, transactions, movements ([#42](https://github.com/Elmorralito/save-ma-money/issues/42) epic)                                   |
| Active work  | PPT-037 transactions/movements ([#47](https://github.com/Elmorralito/save-ma-money/issues/47)); reports deferred ([#48](https://github.com/Elmorralito/save-ma-money/issues/48)) |
