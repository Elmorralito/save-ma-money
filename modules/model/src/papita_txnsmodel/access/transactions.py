...
class IdentifiedTransactionsRepository(OwnedTableRepository, metaclass=MetaSingleton):
    ...
    The repository works with IdentifiedTransactions objects and provides all the CRUD
    ...
    Attributes:
        __expected_dao_type__ (type[IdentifiedTransactions]): The expected DAO type for this
            repository, set to IdentifiedTransactions.
    """

    __expected_dao_type__ = IdentifiedTransactions
...
class TransactionsRepository(OwnedTableRepository, metaclass=MetaSingleton):
    ...
    The repository works with Transactions objects and provides all the CRUD
    operations inherited from OwnedTableRepository, including querying, inserting, updating,
    and deleting transaction records.

    Attributes:
        __expected_dao_type__ (type[Transactions]): The expected DAO type for this
            repository, set to Transactions.
    """

    __expected_dao_type__ = Transactions
