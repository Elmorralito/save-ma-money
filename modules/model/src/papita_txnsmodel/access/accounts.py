...
class AccountsRepository(OwnedTableRepository, metaclass=MetaSingleton):
    ...
    The repository works with Accounts objects and provides all the CRUD
    operations inherited from BaseRepository, including querying, inserting,
    updating, and deleting account records.

    Attributes:
        __expected_dao_type__ (type[Accounts]): The expected DAO type for this
            repository, set to Accounts.
    """

    __expected_dao_type__ = Accounts
