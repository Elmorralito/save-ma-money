...
## Auth assumptions (PPT-060 / #125)

- Default path: **confirmed** (or confirm-N/A) seed user → BFF cookie login.
- Unconfirmed / resend / SMTP journeys wait on [#139](https://github.com/Elmorralito/save-ma-money/issues/139).
- Optional SPA register: `E2E_LIVE_REGISTER=1 pnpm web:test:e2e`.
